  ...
  return (
    <div className="min-h-screen px-10 py-5 bg-gradient-to-b from-white to-teal-50 flex flex-col">
      <main className="flex-grow">
        <CoursesSection title="Khóa học đang học" courses={allCourses} />
        <CoursesSection title="Khóa học mới" courses={allCourses} />
        <CoursesSection title="Khóa học nổi bật" courses={allCourses} />
        <CoursesSection title="Tất cả khóa học" courses={allCourses} />
      </main>
    </div>
  );
};
